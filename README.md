...
Cuckoo is part of complex environment around BrainLab .SIG files, because we were actively recording with this old system until 2024. There is also EEGLE Nest - recording database and EEGLE reader (work in progress).
